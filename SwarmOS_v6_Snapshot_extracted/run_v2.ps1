...
Start-Process powershell -ArgumentList "-NoExit", "-Command", ".\venv\Scripts\Activate.ps1; `$env:PYTHONPATH = '.'; `$env:OLLAMA_VULKAN = '1'; `$env:OLLAMA_NUM_PARALLEL = '2'; `$env:OLLAMA_MAX_LOADED_MODELS = '2'; python swarm_v2/app_v2.py" -NoNewWindow
